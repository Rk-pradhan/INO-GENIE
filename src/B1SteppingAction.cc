...
if(step->GetPreStepPoint()->GetPhysicalVolume()->GetName()=="GlassPlate")
  ...
  //  if(step->GetTrack()->GetDefinition()->GetPDGEncoding()==13){
    ...
    man->FillNtupleDColumn(4, step->GetTrack()->GetMomentum().x());
    man->FillNtupleDColumn(5, step->GetTrack()->GetMomentum().y());
    man->FillNtupleDColumn(6, step->GetTrack()->GetMomentum().z());
